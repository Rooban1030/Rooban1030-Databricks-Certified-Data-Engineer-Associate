...
-- MAGIC %fs
-- MAGIC  ls dbfs:/mnt/demo-datasets/bookstore/customers-json/export_001.json
...
SELECT * FROM json.`${dataset.bookstore}/customers-json/export_*.json` limit 10;
...
-- Adds a column 'source file' to o/p to show the data file path
 SELECT *,
